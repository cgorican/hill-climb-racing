...
class Score(val racerId: UUID, val startTime: LocalDateTime, val finishTime: LocalDateTime): Comparable<Score> {
    ...
    override fun toString(): String {
        ...
        return String.format("%02d:%02d:%02d.%03d", hrs,min,secs,millis)
    }
}